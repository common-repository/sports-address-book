...
if(!function_exists("get_terms")) :
	function sab_get_terms( $args = array(), $deprecated = '' ) {
		global $wpdb;
		 ...
		 * @param array         $taxonomies An array of taxonomies.
		 * @param array         $args       An array of sab_get_terms() arguments.
...
{
	$delete = get_pages( array( 'post_type' => 'address-book' ) );
